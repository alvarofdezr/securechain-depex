...
class VersionFilter:
    ...
    @staticmethod
    def get_version_range_type(
        node_type: str,
    ) -> tuple[type[Version], type[VersionRange]]:
    ...
    @staticmethod
    def filter_versions(
        node_type: str, versions: list[dict[str, Any]], constraints: str
    ) -> list[dict[str, Any]]:
        ...
        version_type, version_range_type = VersionFilter.get_version_range_type(
            node_type
        )
